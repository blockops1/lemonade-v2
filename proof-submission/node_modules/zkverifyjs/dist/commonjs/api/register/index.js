...
async function registerVk(connection, options, verificationKey) {
    ...
    const selectedAccount = (0, helpers_1.getSelectedAccount)(connection, accountAddress);
    ...
    const transactionResult = new Promise((resolve, reject) => {
        (0, transactions_1.handleTransaction)(connection.api, registerExtrinsic, selectedAccount, undefined, emitter, options, enums_1.TransactionType.VKRegistration)
            .then(resolve)
            .catch((error) => {
